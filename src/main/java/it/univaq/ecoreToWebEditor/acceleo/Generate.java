...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static String MODULE_FILE_NAME = "./mtl/generate.emtl";
     ...
     * <p>
     * The core reason for this constructor is to allow clients of this
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                 ...
                 * of the Acceleo module with the core template that has caused the creation of this class will
                 * revert your modifications.
                 */

                /*
                 * Add in this list all the arguments used by the starting point of the generation
                 * If your core template is called on an element of your model and a String, you can
    ...
    public void doGenerate(Monitor monitor) throws IOException {
         ...
         * any compilation of the Acceleo module with the core template that has caused the creation of this
    ...
    public List<IAcceleoTextGenerationListener> getGenerationListeners() {
         ...
         * to "@generated NOT". Without this new tag, any compilation of the Acceleo module with the core template
